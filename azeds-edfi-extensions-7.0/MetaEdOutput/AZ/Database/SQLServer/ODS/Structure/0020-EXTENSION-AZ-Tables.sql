...
CREATE TABLE [az].[AssessmentOutcomesSummaryDescriptor] (
    ...
    CONSTRAINT [AssessmentOutcomesSummaryDescriptor_PK] PRIMARY KEY CLUSTERED (
        [AssessmentOutcomesSummaryDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [az].[CourseTranscriptExtension] ADD CONSTRAINT [CourseTranscriptExtension_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [az].[FinalLetterGradeDescriptor] (
    ...
    CONSTRAINT [FinalLetterGradeDescriptor_PK] PRIMARY KEY CLUSTERED (
        [FinalLetterGradeDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [az].[StudentSpecialEducationProgramAssociationAssessmentOutcome] (
    ...
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [StudentSpecialEducationProgramAssociationAssessmentOutcome_PK] PRIMARY KEY CLUSTERED (
...
GO
ALTER TABLE [az].[StudentSpecialEducationProgramAssociationAssessmentOutcome] ADD CONSTRAINT [StudentSpecialEducationProgramAssociationAssessmentOutcome_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
