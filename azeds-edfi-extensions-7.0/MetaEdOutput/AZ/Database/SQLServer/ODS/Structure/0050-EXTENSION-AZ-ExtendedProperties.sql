...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This descriptor holds the outcomes of an assessment based on format and content.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'AssessmentOutcomesSummaryDescriptor'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'AssessmentOutcomesSummaryDescriptor', @level2type=N'COLUMN', @level2name=N'AssessmentOutcomesSummaryDescriptorId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to a local education agency.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CalendarExtension', @level2type=N'COLUMN', @level2name=N'TrackLocalEducationAgencyId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The first date of the track', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CalendarExtension', @level2type=N'COLUMN', @level2name=N'BeginDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The last date of the track', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CalendarExtension', @level2type=N'COLUMN', @level2name=N'EndDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The total number of instructional days in the school calendar.
                National Education Data Model (NEDM): Total Days in Session', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CalendarExtension', @level2type=N'COLUMN', @level2name=N'TotalInstructionalDays'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The result from the student''s attempt to take the course, for example:
        ...
        Fail
        Incomplete
        Withdrawn.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'CourseAttemptResultDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a course.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'CourseCode'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'CourseEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'EducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier for the school year.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'SchoolYear'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The term for the session during the school year.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'TermDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The final indicator of student performance in a class as submitted by the instructor', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'FinalLetterGradeDescriptorId'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The final indicator of student performance in a class as submitted by the instructor.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'FinalLetterGradeDescriptor'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'FinalLetterGradeDescriptor', @level2type=N'COLUMN', @level2name=N'FinalLetterGradeDescriptorId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Minutes reported per week', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'SectionExtension', @level2type=N'COLUMN', @level2name=N'MinutesPerWeek'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The earliest date the student is involved with the program. Typically, this is the date the student becomes eligible for the program.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentDropOutRecoveryProgramAssociation', @level2type=N'COLUMN', @level2name=N'BeginDate'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The earliest date the student is involved with the program. Typically, this is the date the student becomes eligible for the program.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentDropOutRecoveryProgramMonthlyUpdate', @level2type=N'COLUMN', @level2name=N'BeginDate'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'An American Indian tribe with which an individual is affiliated.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentEducationOrganizationAssociationAZTribalAffiliation'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentEducationOrganizationAssociationAZTribalAffiliation', @level2type=N'COLUMN', @level2name=N'EducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentEducationOrganizationAssociationAZTribalAffiliation', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'An American Indian tribe with which an individual is affiliated.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentEducationOrganizationAssociationAZTribalAffiliation', @level2type=N'COLUMN', @level2name=N'TribalAffiliationDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Tribal affiliation(s) other than Arizona’s 22 federally recognized tribes.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentEducationOrganizationAssociationAZTribalAffiliation', @level2type=N'COLUMN', @level2name=N'OtherAffiliation'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This descriptor defines a student need category.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentNeedCategoryDescriptor'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This descriptor defines a category of a student need.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentNeedDescriptor', @level2type=N'COLUMN', @level2name=N'StudentNeedCategoryDescriptorId'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This entity collection represents the SPED outcomes of students at an education organization.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationAssessmentOutcome'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This descriptor holds the category of an assessment based on format and content.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationAssessmentOutcome', @level2type=N'COLUMN', @level2name=N'AssessmentCategoryDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This descriptor holds the period of time window in which an assessment is supposed to be administered (e.g., Beginning of Year, Middle of Year, End of Year).', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationAssessmentOutcome', @level2type=N'COLUMN', @level2name=N'AssessmentPeriodDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The earliest date the student is involved with the program. Typically, this is the date the student becomes eligible for the program.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationAssessmentOutcome', @level2type=N'COLUMN', @level2name=N'BeginDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationAssessmentOutcome', @level2type=N'COLUMN', @level2name=N'EducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationAssessmentOutcome', @level2type=N'COLUMN', @level2name=N'ProgramEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The formal name of the Program of instruction, training, services, or benefits available through federal, state, or local agencies.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationAssessmentOutcome', @level2type=N'COLUMN', @level2name=N'ProgramName'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The type of program.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationAssessmentOutcome', @level2type=N'COLUMN', @level2name=N'ProgramTypeDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationAssessmentOutcome', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This descriptor holds the outcome of an Assesment based on the Assessment Category', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationAssessmentOutcome', @level2type=N'COLUMN', @level2name=N'AssessmentOutcomesSummaryDescriptorId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The earliest date the student is involved with the program. Typically, this is the date the student becomes eligible for the program.', @level0type=N'SCHEMA', @level0name=N'az', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationExtension', @level2type=N'COLUMN', @level2name=N'BeginDate'
GO
