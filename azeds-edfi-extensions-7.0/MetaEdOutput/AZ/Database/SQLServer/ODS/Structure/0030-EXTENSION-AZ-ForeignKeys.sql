...
ALTER TABLE [az].[AssessmentOutcomesSummaryDescriptor] WITH CHECK ADD CONSTRAINT [FK_AssessmentOutcomesSummaryDescriptor_Descriptor] FOREIGN KEY ([AssessmentOutcomesSummaryDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [az].[CourseTranscriptExtension] WITH CHECK ADD CONSTRAINT [FK_CourseTranscriptExtension_CourseTranscript] FOREIGN KEY ([CourseAttemptResultDescriptorId], [CourseCode], [CourseEducationOrganizationId], [EducationOrganizationId], [SchoolYear], [StudentUSI], [TermDescriptorId])
...
ALTER TABLE [az].[CourseTranscriptExtension] WITH CHECK ADD CONSTRAINT [FK_CourseTranscriptExtension_FinalLetterGradeDescriptor] FOREIGN KEY ([FinalLetterGradeDescriptorId])
REFERENCES [az].[FinalLetterGradeDescriptor] ([FinalLetterGradeDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_CourseTranscriptExtension_FinalLetterGradeDescriptor]
...
ALTER TABLE [az].[FinalLetterGradeDescriptor] WITH CHECK ADD CONSTRAINT [FK_FinalLetterGradeDescriptor_Descriptor] FOREIGN KEY ([FinalLetterGradeDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [az].[StudentSpecialEducationProgramAssociationAssessmentOutcome] WITH CHECK ADD CONSTRAINT [FK_StudentSpecialEducationProgramAssociationAssessmentOutcome_AssessmentCategoryDescriptor] FOREIGN KEY ([AssessmentCategoryDescriptorId])
REFERENCES [edfi].[AssessmentCategoryDescriptor] ([AssessmentCategoryDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentSpecialEducationProgramAssociationAssessmentOutcome_AssessmentCategoryDescriptor]
ON [az].[StudentSpecialEducationProgramAssociationAssessmentOutcome] ([AssessmentCategoryDescriptorId] ASC)
GO

ALTER TABLE [az].[StudentSpecialEducationProgramAssociationAssessmentOutcome] WITH CHECK ADD CONSTRAINT [FK_StudentSpecialEducationProgramAssociationAssessmentOutcome_AssessmentOutcomesSummaryDescriptor] FOREIGN KEY ([AssessmentOutcomesSummaryDescriptorId])
REFERENCES [az].[AssessmentOutcomesSummaryDescriptor] ([AssessmentOutcomesSummaryDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentSpecialEducationProgramAssociationAssessmentOutcome_AssessmentOutcomesSummaryDescriptor]
ON [az].[StudentSpecialEducationProgramAssociationAssessmentOutcome] ([AssessmentOutcomesSummaryDescriptorId] ASC)
GO

ALTER TABLE [az].[StudentSpecialEducationProgramAssociationAssessmentOutcome] WITH CHECK ADD CONSTRAINT [FK_StudentSpecialEducationProgramAssociationAssessmentOutcome_AssessmentPeriodDescriptor] FOREIGN KEY ([AssessmentPeriodDescriptorId])
REFERENCES [edfi].[AssessmentPeriodDescriptor] ([AssessmentPeriodDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentSpecialEducationProgramAssociationAssessmentOutcome_AssessmentPeriodDescriptor]
ON [az].[StudentSpecialEducationProgramAssociationAssessmentOutcome] ([AssessmentPeriodDescriptorId] ASC)
GO

ALTER TABLE [az].[StudentSpecialEducationProgramAssociationAssessmentOutcome] WITH CHECK ADD CONSTRAINT [FK_StudentSpecialEducationProgramAssociationAssessmentOutcome_StudentSpecialEducationProgramAssociation] FOREIGN KEY ([BeginDate], [EducationOrganizationId], [ProgramEducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId], [StudentUSI])
...
CREATE NONCLUSTERED INDEX [FK_StudentSpecialEducationProgramAssociationAssessmentOutcome_StudentSpecialEducationProgramAssociation]
