...
-- Table [ne].[CareerEducationProgramDescriptor] --
CREATE TABLE [ne].[CareerEducationProgramDescriptor] (
    [CareerEducationProgramDescriptorId] [INT] NOT NULL,
    CONSTRAINT [CareerEducationProgramDescriptor_PK] PRIMARY KEY CLUSTERED (
        [CareerEducationProgramDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [ne].[DisciplineActionExtension] (
    ...
    [GFSAAlternativePlacement] [BIT] NULL,
    [CreateDate] [DATETIME] NOT NULL,
...
-- Table [ne].[StudentCTEProgramAssociationExtension] --
CREATE TABLE [ne].[StudentCTEProgramAssociationExtension] (
    ...
    [StudentUSI] [INT] NOT NULL,
    [CareerEducationProgramDescriptorId] [INT] NULL,
    [CreateDate] [DATETIME] NOT NULL,
...
GO
ALTER TABLE [ne].[StudentCTEProgramAssociationExtension] ADD CONSTRAINT [StudentCTEProgramAssociationExtension_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
