...
ALTER TABLE [ne].[CareerEducationProgramDescriptor] WITH CHECK ADD CONSTRAINT [FK_CareerEducationProgramDescriptor_Descriptor] FOREIGN KEY ([CareerEducationProgramDescriptorId])
...
ALTER TABLE [ne].[StudentCTEProgramAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentCTEProgramAssociationExtension_CareerEducationProgramDescriptor] FOREIGN KEY ([CareerEducationProgramDescriptorId])
REFERENCES [ne].[CareerEducationProgramDescriptor] ([CareerEducationProgramDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentCTEProgramAssociationExtension_CareerEducationProgramDescriptor]
ON [ne].[StudentCTEProgramAssociationExtension] ([CareerEducationProgramDescriptorId] ASC)
GO

ALTER TABLE [ne].[StudentCTEProgramAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentCTEProgramAssociationExtension_StudentCTEProgramAssociation] FOREIGN KEY ([BeginDate], [EducationOrganizationId], [ProgramEducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId], [StudentUSI])
